...
namespace Bazaar.Pages
{
    public partial class Programs : System.Web.UI.Page
    {
        ...
        {
            Page.Title = "شبکه تلویزیونی بازار" + " :: " + " برنامه ها ";
            BuildPage();
        }
        private void BuildPage()
        {
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules = Page_Module_Sql.Select_ByPageId_Position(1010, 1029);
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules2 = Page_Module_Sql.Select_ByPageId_Position(1010, 1028);
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules3 = Page_Module_Sql.Select_ByPageId_Position(1010, 1030);
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules4 = Page_Module_Sql.Select_ByPageId_Position(1010, 1031);
