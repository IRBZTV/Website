...
namespace Bazaar.Pages
{
    public partial class Schedules : System.Web.UI.Page
    {
        ...
        {
            Page.Title = "شبکه تلویزیونی بازار" + " :: " + " جدول پخش برنامه ها ";
            BuildPage();
        }
        private void BuildPage()
        {
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules = Page_Module_Sql.Select_ByPageId_Position(1012, 1037);
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules2 = Page_Module_Sql.Select_ByPageId_Position(1012, 1036);
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules3 = Page_Module_Sql.Select_ByPageId_Position(1012, 1038);
            ...
            List<BusinessLayer.PAGE_MODULES> Page_Modules4 = Page_Module_Sql.Select_ByPageId_Position(1012, 1039);
