<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newsprint.aspx.cs" Inherits="Bazaar.Pages.newsprint" EnableViewState="false" ViewStateMode="Disabled" %>

<%@ Register Src="../Modules/Contents/Print/PrintView.ascx" TagName="PrintView" TagPrefix="uc1" %>
        ...
        <div class="container">          
            <div class="row">            
                <section id="main" class="span12">
                    <uc1:PrintView ID="PrintView1" runat="server" />
                </section>
            </div>
        </div>
    </section>
